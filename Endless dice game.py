...
player1 = Label (root, text = "Player 1", bg = "aqua", fg = "white")
player1.place(relx = 0.1, rely = 0.3 , anchor = CENTER)

player2 = Label (root, text = "Player 2", bg = "aqua", fg = "white")
player2.place(relx = 0.9, rely = 0.3 , anchor = CENTER)

player_1_score_label = Label(root , bg = "aqua", fg = "white")
player_1_score_label.place(relx = 0.1, rely = 0.4 , anchor = CENTER)

player_2_score_label = Label(root , bg = "aqua", fg = "white")
...
def player1 ():
    ...
    def player2 ():
        ...
        player2_score = player1_score + random_no
